...
public class DisjuntorDTO {
        ...
        @NotNull
        private Long tipoEquipamentoId; // Use o tipo adequado para representar o ID do TipoEquipamento

        private Long stationId; // Use o tipo adequado para representar o ID da StationModel (se necessário)
